...
const Hotelcard = ({room, index}) => {
    return(
        ...
        className=" group relative max-w-60 mt-5 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow 
            [0px_4px_4px_rgba(0,0,0,0.05)] "  >

            <img src={room.images[0]} alt="hitels-room"  className='group-hover:scale-110 transition'/>
            ...
            <div className="p-4 pt-5">
                <div className="flex items-center justify-between">
                  <p className="font-playfair text-xl font-medium font-gray-800">
                      {room.hotel.name} </p>
