...
const Hero = () => {
  return (
    ...
    bg-no-repeate bg-cover bg-center h-screen"
    >
      <p className="rounded-full py-1 px-3.5 mt-20 bg-blue-400">
        The Ultimate Hotel Experience
      </p>
      <h1 className="max-w-xl font-playfair text-2xl md:text-5xl md:text-[56px] md:leading[56px] font-bold md:font-extrabold mt-4">
        Discover Your Perfect Gateway Destination
      </h1>
      <p className="max-w-130 text-xl mt-2 text-sm md:text-base">
        ...
        <div>
          ...
          <input list="destinations" id="destinationInput" type="text" className=" rounded border border-gray-200 px-3 py-1.5 mt-1.5 text-sm outline-none"
            ...
            <datalist id="destinations">
                ...
                { cities.map( ( city, index) => (                         // using datalist tag to maping cities name from assets folder
